...
export const ComingSoon = ({ pageName }: ComingSoonProps) => {
    ...
    return (
        <div className="w-full min-h-[calc(100vh-120px)] relative overflow-hidden flex flex-col items-center justify-center text-center px-4" style={{ backgroundColor: 'var(--bg)', color: 'var(--text)' }}>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-[var(--primary)]/5 rounded-full blur-[120px] pointer-events-none" />
            ...
            <svg width="100%" height="150" viewBox="0 0 500 150" className="mb-8 sm:mb-12 relative z-10 max-w-full" preserveAspectRatio="xMidYMid meet">
                ...
                <Node x={200} y={75} type="commit" delay={0.6} color="var(--primary)" />
                <Node x={430} y={75} type="commit" delay={1.2} color="var(--accent)" />
            </svg>
            ...
            <div className="relative z-10 px-4 max-w-full">
                ...
                >
                    PAGE_STATUS: <span className="text-[var(--primary)] block sm:inline">
                ...
                <motion.div
                    ...
                    className="space-y-2"
                >
                    <p className="text-[var(--accent)] font-mono text-xs sm:text-sm uppercase tracking-[0.2em] sm:tracking-[0.3em] break-words">
