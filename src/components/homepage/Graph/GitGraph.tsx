                    ...
                    >
                        ...
                        {isMobile && (
                            <div className="relative mx-auto mt-4 h-[104px] w-full pointer-events-auto">
                                ...
                                >
                                    {[{ label: 'LinkedIn', href: 'https://www.linkedin.com/company/the-init-club/', icon: Linkedin }, { label: 'Instagram', href: 'https://www.instagram.com/the.init.club?igsh=MTFlcWg1eWIyMTNyaA==', icon: Instagram }, { label: 'Discord', href: 'https://discord.gg/Crsv7CdXD', icon: Discord }].map((social, index) => (
                                        <motion.a
                                            key={social.label}
                                            href={social.href}
                                            target="_blank"
