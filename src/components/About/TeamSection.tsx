    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative max-w-sm w-full bg-[#0a0a0a] border border-glass-border rounded-xl overflow-hidden"
          style={{
        ...
        >
          {/* Header */}
          <div
            className="flex items-center justify-between px-4 py-2 border-b border-glass-border"
            style={{
          ...
          <div className="p-4">
            ...
            <div className="mt-4 text-center">
              <div className="flex items-center justify-center gap-1 mb-1">
                ...
                <h3 className="font-mono text-text font-bold text-lg">
                  {member.username}
                </h3>
              </div>
              <p
                className="text-sm font-mono uppercase tracking-wide mb-4"
              ...
              <div className="flex items-center justify-center gap-3">
                {member.github && (
                  <a
                    ...
                    className="p-2.5 rounded-md bg-[#0f0f0f] border border-glass-border text-muted hover:text-white hover:border-[#333] transition-all duration-200"
                  >
                ...
                {member.linkedin && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2.5 rounded-md bg-[#0f0f0f] border border-glass-border text-muted hover:text-[#0a66c2] hover:border-[#0a66c2]/50 transition-all duration-200"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                {member.instagram && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2.5 rounded-md bg-[#0f0f0f] border border-glass-border text-muted hover:text-[#e4405f] hover:border-[#e4405f]/50 transition-all duration-200"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
const executiveBoard: TeamMember[] = [
  ...
  },
  {
    ...
    avatar: Meghana,
    github: 'https://github.com/MeghanaKotharu25',
    linkedin: 'https://www.linkedin.com/in/meghana-k-a65a25319?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app',
    instagram: 'https://www.instagram.com/_.meghana_k?igsh=MXBxMWFmMXVjdzBo',
    tier: 'sudo',
  },
  {
...
const technicalLeads: TeamMember[] = [
  {
    ...
    instagram: 'https://www.instagram.com/nitansh_kun?igsh=MWF2Z2V6dng1M25wNA==',
    tier: 'maintainer',
  },
  {
    ...
    role: 'Research Lead',
    avatar: Saivarun,
    github: 'https://github.com/VARUNEMANI',
    linkedin: 'https://www.linkedin.com/in/varun-emani-b6a9a42b1/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app',
    instagram: 'https://www.instagram.com/varun_emani?igsh=ZGtndmNidDJzcnlp&utm_source=qr',
    tier: 'maintainer',
  },
  {
    username: 'Sanjith M',
    ...
    linkedin: 'https://linkedin.com/in/s4nj1th',
...
const operationsLeads: TeamMember[] = [
  ...
  },
  {
    ...
    role: 'Logistics Lead',
    avatar: Bhargav,
    instagram: 'https://www.instagram.com/mkbhargavasrisai?igsh=cmtjNGFpZXBsNzM2',
    linkedin: 'https://www.linkedin.com/in/bhargava-sri-sai-m-k-79b574341?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app',
    tier: 'orchestrator',
  },
  {
    username: 'Ganesh C',
    role: 'PR Lead',
    avatar: Ganesh,
    instagram: 'https://www.instagram.com/ganesh_cholai?igsh=MWV3dmJodmZlOWMydg==',
    tier: 'orchestrator',
  },
  {
    ...
    avatar: Harini,
    instagram: 'https://www.instagram.com/harini._bachu?igsh=MW5rdmd4YzJrdHQ3cg==',
    tier: 'orchestrator',
  },
];
  ...
  return (
    ...
    >
      ...
      >
        {/* Header Bar */}
        <div
          className="flex items-center justify-between px-3 py-1.5 border-b border-glass-border"
          style={{
            background: isLarge
        ...
        <div className={isLarge ? 'p-5' : 'p-4'}>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex items-center gap-1 mb-1">
              ...
              <h3 className="font-mono text-text font-bold">
                <GlitchText
            ...
            {/* Role */}
            <p
              className={`${isLarge ? 'text-xs' : 'text-[10px]'} font-mono uppercase tracking-wide`}
              style={{ color: config.badgeColor }}
            >
              {member.role}
            </p>
              ...
              <div className="flex items-center gap-2 pt-3">
                {member.github && (
                  <a
                    ...
                    rel="noopener noreferrer"
                    onClick={(e) => e.stopPropagation()}
                    className="p-2 rounded-md bg-[#0f0f0f] border border-glass-border text-muted hover:text-white hover:border-[#333] transition-all duration-200"
                  >
                    <GitHubIcon />
                  </a>
                )}
                {member.linkedin && (
                  <a
                    ...
                    rel="noopener noreferrer"
                    onClick={(e) => e.stopPropagation()}
                    className="p-2 rounded-md bg-[#0f0f0f] border border-glass-border text-muted hover:text-[#0a66c2] hover:border-[#0a66c2]/50 transition-all duration-200"
                  >
                    <LinkedInIcon />
                  </a>
                )}
                {member.instagram && (
                  <a
                    ...
                    rel="noopener noreferrer"
                    onClick={(e) => e.stopPropagation()}
                    className="p-2 rounded-md bg-[#0f0f0f] border border-glass-border text-muted hover:text-[#e4405f] hover:border-[#e4405f]/50 transition-all duration-200"
                  >
                    <InstagramIcon />
                  </a>
                )}
  ...
  return (
    <div className="mb-14">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <span
            ...
            style={{ backgroundColor: config.badgeColor }}
          />
          <h3 className="text-base font-heading text-text">
            {title}
          </h3>
          <span
      ...
      <motion.div
        ...
        className={`grid ${gridCols} gap-5 justify-items-center max-sm:[&>*:last-child:nth-child(odd)]:col-span-full max-sm:[&>*:last-child:nth-child(odd)]:max-w-[260px]`}
      >
        {members.map((member) => (
  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 mb-12">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 mb-4 px-3 py-1 bg-[#0f0f0f] border border-glass-border rounded-full">
        ...
        <div className="-mt-8 mb-14">
          ...
          >
            {executiveBoard.slice(1).map((member) => (
              <ProfileCard key={member.username} member={member} isLarge={true} onImageClick={handleImageClick} />
            ))}
          </motion.div>
        </div>
      ...
      {/* Image Lightbox */}
      {selectedMember && (
        <ImageLightbox member={selectedMember} onClose={handleCloseLightbox} />
      )}
    </section>
  );
};
