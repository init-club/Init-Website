...
const COLORS = {
  ...
  get join() { return getColor('--color-projects') || '#00ffd5'; },   // Cyan
  get projects() { return getColor('--color-blogs') || '#a855f7'; },  // Purple
  get blogs() { return getColor('--color-events') || '#ff3366'; },    // Red
  get events() { return getColor('--color-contact') || '#2979ff'; },  // Blue
};
