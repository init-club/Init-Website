...
const COLORS = {
  get neutral() { return getColor('--color-neutral') || 'var(--text)'; },
  get about() { return getColor('--color-about') || '#f59e0b'; },
  get join() { return getColor('--color-projects') || '#6366f1'; },
  get projects() { return getColor('--color-blogs') || '#8b5cf6'; },
  get blogs() { return getColor('--color-events') || '#ec4899'; },
  get events() { return getColor('--color-contact') || '#10b981'; },
};
...
export const DESKTOP_EDGES: GraphEdge[] = [
  // Init -> C1 (Base Line) - Neutral
  { id: 'e1', from: 'init', to: 'c1', delay: 0, duration: 0.6, label: 'main', color: COLORS.neutral },

  // C1 -> About Chain - Variable
  { id: 'e_a1', from: 'c1', to: 'c2_a', delay: 0.5, duration: 0.4, label: 'GET TO KNOW US', color: COLORS.about, labelDy: -15, labelOffset: '90%', labelAnchor: 'end' },
  { id: 'e_a2', from: 'c2_a', to: 'nav_about', delay: 0.9, duration: 0.6, color: COLORS.about },

  // C1 -> Join Us Chain - Variable 
  { id: 'e_p1', from: 'c1', to: 'c2_p', delay: 0.6, duration: 0.5, color: COLORS.join, label: 'INTERESTED? JOIN US!', labelDy: -15, labelOffset: '35%', labelAnchor: 'start' },
  { id: 'e_p2', from: 'c2_p', to: 'nav_projects', delay: 1.1, duration: 0.8, color: COLORS.join },

  // C1 -> Blogs Chain - Variable 
  { id: 'e_e1', from: 'c1', to: 'c2_e', delay: 0.6, duration: 0.5, label: 'WRITTEN BY US', color: COLORS.blogs, labelDy: -15, labelOffset: '90%', labelAnchor: 'end' },
  { id: 'e_e2', from: 'c2_e', to: 'nav_events', delay: 1.1, duration: 0.8, color: COLORS.blogs },

  // Projects -> Projects Split - Variable
  { id: 'e_b1', from: 'c2_p', to: 'c3_b', delay: 1.1, duration: 0.4, label: 'OUR WORKS', color: COLORS.projects, labelDy: -15, labelOffset: '95%', labelAnchor: 'end' },
  { id: 'e_b2', from: 'c3_b', to: 'nav_blogs', delay: 1.5, duration: 0.6, color: COLORS.projects },

  // Projects -> Events Split - Variable
  { id: 'e_c1', from: 'c2_p', to: 'nav_contact', delay: 1.1, duration: 1.0, label: 'HOSTED BY US FOR YOU', color: COLORS.events, labelDy: 25, labelOffset: '70%', labelAnchor: 'end' },
];
